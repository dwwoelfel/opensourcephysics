...
public class FunctionTool extends JDialog {
  ...
  protected Component[] customButtons;                                                  // may be null
   ...
   *
   * @param comp Component used to get Frame owner of this Dialog
   * @param buttons an array of custom buttons or other components
   */
  public FunctionTool(Component comp, Component[] buttons) {
